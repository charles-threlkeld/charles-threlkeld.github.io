...
◊projects{
  ...
  ◊item{◊item-name{Another Language ANalyzer (ALAN)}: Multi-media academic application for Jeffersonian transcription to create rich linguistic annoations.}
...
}  ◊item{◊item-name{◊title{John Company}}: Model the board game ◊title{John Company} (◊title{Sierra Madre Games} 2017) in order to help the designer and developer more fully understand how changes to the random event probabilities affect the game state throughout the game play.}
}

◊computer-skills{
  ◊basic-skills{HTML, CSS, Javascript}
  ◊intermediate-skills{Linux, Microsoft Windows, Ruby, ML, Clojure, git, SQL, ◊latex}
  ◊advanced-skills{Python, Data Science, R, Racket}
}
